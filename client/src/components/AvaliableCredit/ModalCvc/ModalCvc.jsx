    ...
    >
      ...
      >
        <DivGeneric $gap="1rem">
          ...
          <DivGeneric $width="2rem" $cursor="pointer" onClick={() => handleClipBoard(state.cvu)} $aItems="center">
            <BiCopy/>
          </DivGeneric>
        </DivGeneric>
        <DivGeneric $gap="1rem">
          <Text>alias: {state.alias}</Text>
          <DivGeneric $width="2rem" $cursor="pointer" onClick={() => handleClipBoard(state.alias)} $aItems="center">
            <BiCopy/>
          </DivGeneric>
        </DivGeneric>
      </DivGeneric>
